...
export const wholesaleLeadFollowupStages: WholesaleLeadFollowupStage[] = [
  {
    ...
    dayOffset: 14,
    subject: 'How did your Bare samples work out?',
    headline: 'Checking in on your samples',
    preview: 'A quick check-in on your sample pack, plus next steps if Bare feels like a fit.',
    ctaLabel: 'Create wholesale account',
    body: (lead) => [
      `Hi ${lead.contact_name},`,
      `Your Bare Naked Pet Co. sample pack should have arrived by now. We hope everything made it to ${lead.store_name} smoothly.`,
      'After reviewing the samples, the next step is simple if Bare feels like a fit for your store. You can create a wholesale account, review pricing, and place an opening order through the wholesale portal.',
      'Bare is designed to be easy for independent retailers to test: no minimums, free shipping, guaranteed product sell-through, 10% off your first order, a free customer sample campaign, and a supported private launch promo for 2-4 weeks.',
      'The welcome offer is available for 14 days after your wholesale account is created.',
