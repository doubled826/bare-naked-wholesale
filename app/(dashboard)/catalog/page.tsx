    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
            ...
            <div key={product.id} className="card overflow-hidden">
              ...
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="badge-info text-xs">{product.category}</span>
                </div>
      ...
      {showCart && (
        <>
          ...
          />
          <div className="fixed top-0 right-0 h-full w-full max-w-md bg-cream-100 z-50 shadow-2xl animate-slide-in-right overflow-y-auto">
