...
export default function DashboardLayout({
    ...
    return (
      <div className="min-h-screen bg-cream-200 flex items-center justify-center">
        <div className="text-center">
          <div className="spinner border-bark-500 mx-auto mb-4" style={{ width: '40px', height: '40px', borderWidth: '3px' }} />
  ...
  return (
    <div className="flex min-h-screen bg-cream-200">
      ...
      {/* Main content area */}
      <main className="flex-1 lg:ml-0 pt-16 lg:pt-0 dashboard-content">
        {children}
      </main>
    </div>
  );
