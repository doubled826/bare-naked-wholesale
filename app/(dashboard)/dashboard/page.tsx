...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (!showShelfTalkerModal) return;
        ...
        <div className="grid max-h-[calc(100vh-2rem)] overflow-y-auto lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="flex flex-col justify-center p-4 sm:p-5 lg:p-6">
            ...
            <div className="mt-4 flex flex-col gap-2.5 sm:flex-row sm:items-center">
              <button type="button" onClick={onShop} className="btn-primary w-full justify-center whitespace-nowrap px-4 py-2.5 text-sm sm:w-auto focus:outline-none focus-visible:ring-2 focus-visible:ring-bark-500 focus-visible:ring-offset-2">
                Complete My Display
