        ...
        <div className="grid max-h-[calc(100vh-2rem)] overflow-y-auto lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="flex flex-col justify-center p-5 sm:p-6 lg:p-7">
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
              <button type="button" onClick={onShop} className="btn-primary w-full justify-center sm:w-auto focus:outline-none focus-visible:ring-2 focus-visible:ring-bark-500 focus-visible:ring-offset-2">
