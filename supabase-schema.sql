...
CREATE TABLE IF NOT EXISTS welcome_offer_reminder_preferences (
  ...
  shelf_talker_popup_seen BOOLEAN NOT NULL DEFAULT false,
  shelf_talker_popup_seen_at TIMESTAMPTZ,
...
CREATE POLICY "Retailers can view their shelf talker fulfillments"
